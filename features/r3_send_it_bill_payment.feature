...
Scenario:JENI5090-C85003-Payment - Landing page
  	...
  	#Then User expect "bill_payment_text_header_text" equal with "bill_payment_text_header_detail"\
    Then User expect "bill_payment_icon_card_center_button" is exist
    Then User expect "bill_payment_icon_insurance_button" is exist
    Then User expect "bill_payment_mobile_top_up_button" is exist
    Then User expect "bill_payment_transportation_button" is exist
    Then User expect "bill_payment_mobile_top_up_button" is exist
    Then User expect "bill_payment_phone_bill_button" is exist
    Then User expect "bill_payment_transportation_button" is exist
  	And User swipe up until found "bill_payment_tv_and_iternet_button"
    Then User expect "bill_payment_tv_and_iternet_button" is exist
    Then User expect "bill_payment_bill_utilities_button" is exist
