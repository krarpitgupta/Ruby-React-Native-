@profilesetting @sendit_profile_setting 
Feature: Profile and Setting Module
  ...
  #take out edit profile
  @android @ios @uispecific
  Scenario:JENI1146-C84807-[Scenario] Go to Notification Settings
  	Given User is on profile and setting page in English language with "flexi_saver_cif_2"
  	When User click "profile_and_setting_settings_tab"
  	And User click "profile_and_setting_notification_settings_button"
  	Then "profile_and_setting_notification_settings_container" will be displayed

  #take out edit profile
  @continuous @android @ios @uispecific
  Scenario:JENI1146-C84808-[Scenario] Changing Notification Settings
  	When User click "profile_and_setting_settings_tab"
  	And User fill "onboarding_password_textfield" with "correct_password"
    And User fill "onboarding_confirm_password_textfield" with "correct_password"
    And User click "profile_and_setting_submit_button"
  ...
  @android @ios @uispecific 
  Scenario:JENI1146-C84809-[Scenario] Enabling Submit Button on Input Your Current Password Screen
  	Given User is on profile and setting page in English language with "flexi_saver_cif_2"
    When User click "profile_and_setting_settings_button"
    And User click "profile_and_setting_change_password_button"
    And User fill "authentication_forgot_pin_password_textfield" with "profile_account_old"
  ...
  @android @ios @uispecific
  Scenario:JENI1146-C84810-[Scenario] Back button
    Given User is on profile and setting page in English language with "flexi_saver_cif_2"
    When User click "profile_and_setting_settings_button"
    And User click "profile_and_setting_change_password_button"
    And User fill "authentication_forgot_pin_password_textfield" with "profile_account_old"
  ...
  @android @ios @uispecific
  Scenario:JENI4328-C92549-[Scenario] Go to Change PIN Screen 1
    Given User is on profile and setting page in English language with "flexi_saver_cif_2"
    When User click "profile_and_setting_settings_button"
  ...
  @android @ios @uispecific
  Scenario:JENI4531-C102145-[Scenario] Go to Change PIN Screen 2
    Given User is on profile and setting page in English language with "flexi_saver_cif_2"
    When User click "profile_and_setting_settings_button"
    And User click "profile_and_setting_change_pin_button"
    Then "profile_and_setting_change_pin_container" will be displayed
  ...
  @android @continuous @ios @uispecific 
  Scenario:JENI4400-C102106-[Scenario] Enabling Next Button on Change Password Screen
    And User wait 5 seconds
    When User click "profile_and_setting_settings_button"
    And User click "profile_and_setting_change_password_button"
    Then "onboarding_next_button" will be displayed
  ...
  Scenario:JENI4400-C102150-[Scenario] Language toggle
    ...
    Then User expect "profile_and_setting_language" equal with "english_language"
  ...
  @android @ios @uispecific
  Scenario:JENI4323-C102303-[Scenario] Enabling Fingerprint Login
    Given User is on profile and setting page in English language with "flexi_saver_cif_2"
    When User click "profile_and_setting_settings_button"
    And User click "profile_and_setting_finger_print_button" 
    Then User expect "profile_and_setting_finger_print_on" equal with "status_on"

  @android @ios @uispecific @continuous
  Scenario:JENI4323-C102303-[Scenario] Enabling Fingerprint Login
    And User click "profile_and_setting_finger_print_button" 
    Then User expect "profile_and_setting_finger_print_on" equal with "status_off"
  ...
  @android @ios @uispecific
  Scenario:JENI4531-C102137-[Scenario] Go to Notification Settings screen
    Given User is on profile and setting page in English language with "flexi_saver_cif_2"
    When User click "profile_and_setting_settings_button"
    And User click "profile_and_setting_notification_settings_button" 
    Then "profile_and_setting_transaction_limit_container" will be displayed
  ...
  @android @ios @uispecific
  Scenario:JENI4531-C102303-[Scenario] Enabling Fingerprint Login (ON)
    Given User is on profile and setting page in English language with "flexi_saver_cif_2"
    When User click "profile_and_setting_settings_button"
    And User click "profile_and_setting_finger_print_button" 
    Then User expect "profile_and_setting_finger_print_on" equal with "status_on"
  ...
  @android @ios @uispecific @continuous
  Scenario:JENI4531-C102303-[Scenario] Enabling Fingerprint Login (OFF)
    And User click "profile_and_setting_finger_print_button" 
    Then User expect "profile_and_setting_finger_print_on" equal with "status_off"

  @android @ios @uispecific
  Scenario:JENI4531-C102149-[Scenario] Go to Transaction Authentication Screen
    Given User is on profile and setting page in English language with "flexi_saver_cif_2"
    When User click "profile_and_setting_settings_button"
    And User click "profile_and_setting_transaction_limit" 
    Then "profile_and_setting_transaction_limit_container" will be displayed
  ...
  @android @ios @uispecific
  Scenario:JENI4531-C102151-[Scenario] Go to Authorized Device Screen
    Given User is on profile and setting page in English language with "flexi_saver_cif_2"
    When User click "profile_and_setting_settings_button"
  ...
  @android @ios @uispecific
  Scenario:JENI5794-C102200-[Scenario] Go to NPWP&Regulatory Details and view the reminder via Edit Profile(New User)
    Given User is on profile and setting page in English language with "flexi_saver_cif"
    When User click "profile_and_setting_edit_button"
    And User swipe up until found "profile_and_setting_npwp_detail_button"
    When User click "profile_and_setting_npwp_detail_button"
    Then User expect "profile_and_setting_npwp_counter_field" equal with "profile_and_setting_npwp_due_date_finished"

  @android @ios @uispecific
  Scenario:JENI5794-C102200-[Scenario] Go to NPWP&Regulatory Details and view the reminder via Edit Profile(Due date finished User)
    Given User is on profile and setting page in English language with "flexi_saver_cif"
    When User click "profile_and_setting_edit_button"
    And User swipe up until found "profile_and_setting_npwp_detail_button"
    When User click "profile_and_setting_npwp_detail_button"
    Then User expect "profile_and_setting_npwp_counter_field" equal with "profile_and_setting_npwp_due_date_full"

  @android @ios @uispecific
  Scenario:JENI5794-C102201-[Scenario] Go to NPWP&Regulatory detail and view the reminder from Profile(New User)
    Given User is on profile and setting page in English language with "flexi_saver_cif"
    And User swipe up until found "profile_and_setting_npwp_detail_button"
    When User click "profile_and_setting_npwp_detail_button"
    Then User expect "profile_and_setting_npwp_counter_field" equal with "profile_and_setting_npwp_due_date_finished"
  ...
  @android @ios @uispecific
  Scenario:JENI5794-C102201-[Scenario] Go to NPWP&Regulatory detail and view the reminder from Profile(Due date finished User)
    Given User is on profile and setting page in English language with "flexi_saver_cif"
    And User swipe up until found "profile_and_setting_npwp_detail_button"
    When User click "profile_and_setting_npwp_detail_button"
    Then User expect "profile_and_setting_npwp_counter_field" equal with "profile_and_setting_npwp_due_date_full"
