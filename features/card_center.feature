...
# JENI-118
@uidatabound @android
Scenario:JENI118-C17795-Verify the card center widget: m-card is Activate, e-card is Active
  Given User is logged in with cif "card_center_active_all_card"
  And User change language to "language"
  Then "dashboard" will be displayed
  And User scroll to "card_center_widget_text"
...
@uidatabound @android
Scenario:JENI118-C17800-Verify the card center widget in case: m-card is Activate, e-card is Processing
  Given User is logged in with cif "card_center_activate_m_card_processing_e_card"
  And User change language to "language"
  Then "dashboard" will be displayed
  And User scroll to "card_center_widget_text"
  And User expect "card_center_m_card_status_dashboard" equal with "card_center_activate"
  And User expect "card_center_e_card_status_dashboard" equal with "card_center_processing"

@uidatabound @android
Scenario:JENI118-C17796-Verify the card center widget: m-card is Active, e-card is Active
...
@uidatabound @android
Scenario:JENI118-C17794-Verify the card center widget in case m-card is Active, e-card is Processing
  Given User is logged in with cif "card_center_active_m_card_processing_e_card"
  And User change language to "language"
  Then "dashboard" will be displayed
  And User scroll to "card_center_widget_text"
...
Scenario: JENI63-C19726#C19727-Change PIN m-Card
  ...
  When User fill "card_center_card_pin_field" with "card_center_correct_change_pin_m_card_pin"
  And User check if "card_center_card_pin_field" field masked
  When User fill "card_center_card_pin_confirm_field" with "card_center_correct_change_pin_m_card_pin"
...
#JENI-239
@uidatabound @android @ios
Scenario:JENI239-C45162-See m-Card Details (active, landing)
  ...
  And User expect "card_center_m_card_clickable" is exist
  ...
  And User expect "card_center_x_card_atm_limit_label" is exist
...
@uidatabound @android @ios
Scenario:JENI239-C43444-See m-Card Details (active, widget)
...
@uidatabound @android @ios
Scenario:JENI239-C45174-See m-Card Details (temporarily blocked, landing)

  Given User is logged in with cif "card_center_tblock_m_card_cif"
  And User change language to "language"
  Then "dashboard" will be displayed
  And User go to card center landing page from side menu
  And User click "card_center_m_card_tblocked_clickable"
...
@uidatabound @android @ios
Scenario:JENI239-C45163-See m-Card Details (temporarily blocked, widget)
...
@uidatabound @android @ios
Scenario:JENI239-C45177-See m-Card Details (permanently blocked, landing)

  Given User is logged in with cif "card_center_pblock_m_card_cif"
  And User change language to "language"
  Then "dashboard" will be displayed
  And User go to card center landing page from side menu
  And User click "card_center_m_card_pblocked_clickable"

  #Several steps are commented because we are still dont have the real data, now the data still using mock and random

  Then "card_center_x_card_image_pblocked" will be displayed
  #And User expect "card_center_m_card_clickable" equal with "card_center_m_card"
  #And User expect "card_center_x_card_number" equal with "card_center_pblock_m_card_masked_number"
  And User expect "card_center_x_card_number" is exist
  #And User expect "card_center_x_card_exp" equal with "card_center_m_card_exp_ui"
  And User expect "card_center_x_card_exp" is exist
  ...
  And User expect "card_center_x_card_trx_limit_label" equal with "card_center_m_card_trx_limit_label"
  #And User expect "card_center_x_card_trx_limit_amt" equal with "card_center_pblock_m_card_trx_limit_amt"
  And User expect "card_center_x_card_atm_limit_label" equal with "card_center_m_card_atm_limit_label"
  #And User expect "card_center_x_card_atm_limit_amt" equal with "card_center_m_card_atm_limit_amt"

@uidatabound @android @ios
Scenario:JENI239-C45175-See m-Card Details (permanently blocked, widget)
...
Scenario:JENI147-C21082-Check layout of the change PIN x-card 
  ...
  Then "card_center_change_pin_page_title" will be displayed
  Then "card_center_change_pin_page_card_picture" will be displayed
  And User expect "card_center_change_pin_page_card_type" equal with "card_center_x_card_ANCILLASURA"
...
# JENI-162
@uidatabound @android
Scenario:JENI162-C67347-[Layout]Delete x-card in Card details (x-card is Active)- More action
  Given User is logged in with cif "card_center_x_card_active_credential_top_up"
  And User change language to "language"
  And User go to card center landing page from side menu
  ...
  Then User expect "card_center_delete_page_submit" equal with "card_center_delete_card_page_submit"
...
# BLOCKED, CARD CENTER WIDGET NOT DISPLAYED
@uidatabound @android
...
@uidatabound @android
Scenario:JENI162-C67389#C67370#C67369#C67345-Delete Active x-Card 
  Given User is logged in with cif "card_center_x_card_active_credential_top_up"
  And User change language to "language"
  And User go to card center landing page from side menu
  And User swipe up until found "card_center_first_x_card_three_dots"
...
# JENI-8075
  ...
  Scenario:JENI8075-C117782-[Scenario] Initiate Refund from Card Details Page
    Given User access card center from left side menu with cif "card_center_special_card"
    And User click "card_center_first_x_card_dashboard"
    And User click "card_center_more_cta_button"
  ...
  Scenario:JENI8075-C117784-[Scenario] Balance on Card
    ...
    And User click "card_center_more_cta_button"
    And User click "card_center_refund_card_popup_menu"
    Then User expect "card_center_refund_active_balance" equal with saved data number 1
  ...
  Scenario:JENI8075-C117787-[Scenario] Active Balance Increase a result of refund
    Given User is logged in with cif "card_center_special_card"
    And User change language to "language"
    And System save "dashboard_wealth_widget_total_active_balance" value
    And User go to card center landing page from side menu
    And User click "card_center_first_x_card_dashboard"
    ...
    And User click "back_button"
    And User go to dashboard from card center detail
    Then User expect "dashboard_wealth_widget_total_active_balance" equal with saved data number 1 plus "card_center_refund_amt"

# JENI-8071
  @android @ios @uidatabound
  Scenario:JENI8071-C117773-[Scenario] 3-dot Card Center landing page - Option to Unblock the card
    Given User access card center from left side menu with cif "card_center_special_card"
    And User swipe up until found "card_center_first_x_card_three_dots"
    And User click "card_center_first_x_card_three_dots"
  ...
  @android @ios @uidatabound
  Scenario:JENI8071-C117775-[Scenario] 3-dot Card Center Widget on Dashboard - Option to Unblock the card
    Given User is logged in with cif "card_center_special_card"
    And User change language to "language"
    And User swipe up until found "card_center_first_x_card_three_dots"
    And User click "card_center_first_x_card_three_dots"
  ...
  Scenario:JENI8071-C117774#C117778-[Scenario] 3-dot Card Center landing page - Unblocking the Card
    Given User access card center from left side menu with cif "card_center_special_card"
    And User swipe up until found "card_center_first_x_card_three_dots"
    And User click "card_center_first_x_card_three_dots"
    And User click "card_center_x_card_satay_unblock_card"
    And User check snackbar with dynamic text "card_center_unblock_x_card"
    Then "card_center_landing_page" will be displayed

  @android @ios @uidatabound
  # JENI8071-C117780-[Scenario] User go to Card Center widget after Unblocking Card
  Scenario:JENI8071-C117776#C117780-[Scenario] 3-dot Card Center Widget on Dashboard - Unblocking the Card
    Given User is logged in with cif "card_center_special_card"
    And User change language to "language"
    And User swipe up until found "card_center_first_x_card_three_dots"
    And User click "card_center_first_x_card_three_dots"
  ...
  Scenario:JENI8071-C117781-[Scenario] Card actions are available after unblocking Temporary Block card
    ...
    Then "card_center_x_card_satay_top_up" will be displayed
    Then "card_center_x_card_satay_refund" will be displayed
    Then "card_center_x_card_satay_delete_card" will be displayed

# JENI-8066
  @android @uidatabound 
  Scenario:JENI8066-C117789-[Scenario] 3 dots menu on m-card page
    Given User is logged in with cif "card_center_special_card"
    And User change language to "language"
    And User go to card center landing page from side menu
    And User swipe up until found "card_center_first_x_card_dashboard"
...
@endtoend @android 
Scenario:JENI8067-C117790-[Scenario] User clicks on Show CVV button in Card Details page
...
Scenario:JENI8067-C117792-[Scenario] Auto hide/mask CVV after 45 seconds
  ...
  Then "card_center_detail" will be displayed
  Then "card_center_x_card_number" will be displayed
  # Need to create new step for card number
  # And User expect "card_center_x_card_number" equal with "card_center_x_card_number"
  And User expect "card_center_x_card_cvv" equal with "card_center_x_card_cvv"
...
@endtoend @android 
Scenario:JENI8067-C117793-Verify error message when enter incorrect password
...
@android @uidatabound @ios
Scenario: JENI8073-C117800-[Mobile] [Scenario] Entering Details on Change Limit Screen - Saving Limits
  Given User is logged in with cif "card_center_special_card"
  And User change language to "language"
  And User go to card center landing page from side menu
  And User swipe up until found "card_center_active_x_card_three_dots"
...
Scenario: JENI8074-C117869-[Mobile] [Scenario] Entering Password Post Changing Pin
  ...
  And User expect "snackbar" contains "card_center_change_pin_success"
...
Scenario: JENI8074-C117870-[Mobile] [Scenario] Error Password
  ...
  And User expect "snackbar" equal with "card_center_change_pin_wrong_password"
