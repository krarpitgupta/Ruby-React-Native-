@r3_authentication_cardcenter @run  
Feature: Release 3 - CARD CENTER (Filter and Transaction) module
...
# Scenario: JENI268-C68191-[Functionality] User is able to enter valid characters in English language in the search input field using on-screen keyboard (mobile web/mobile native) 
#   Given User is logged in with cif "card_center_m_card_transactions_cif"
#   And User change language to "language"
#   And User swipe up until found "card_center_m_card_clickable"
#   And User click "card_center_m_card_clickable"
...
@android @ios @uidatabound
Scenario: JENI270-C68206-[Functionality] Verify 'DONE' button is disabled if 'From' and 'To' value are preset to the default value 0 
  Given User is logged in with cif "card_center_m_card_transaction_history_cif"
  And User change language to "language"
...
Scenario: JENI290-CC69635#C69636#69637-Verify time range filter for 'Last 7 days': If a search has been performed & other filter(s) have been already applied, the applied time range filter should further narrow down the transaction list 
  Given User is logged in with cif "card_center_m_card_transaction_history_cif" in selected environment
  And User change language to "language"
  And User access card center from side menu
  And User click "card_center_close_tutorial"
...
Scenario: JENI291-C68332-Verify there is should be a functional 'SELECT ALL' button 
  ...
  Then "filter_category_selected" will be displayed
  And User swipe up until found "filter_category_games"
  Then "filter_category_selected" will be displayed
...
Scenario: JENI291-C68336-Verify functionality of 'Clear' button 
  ...
  Then "filter_category_selected" will be displayed
  And User click "filter_clear"
  Then "filter_category_not_selected" will be displayed

@android @ios @uidatabound @R3_4
Scenario: JENI291-C68337-Verify functionality of 'Done' button 
  ...
  And User click "filter_icon"
  And User click "filter_category"
  And User swipe up until found "filter_category_children"
...
Scenario: JENI291-C68344-Verify functionality of filter counter 
  ...
  And User click "filter_icon"
  And User click "filter_category"
  And User swipe up until found "filter_category_utilities"
  And User click "filter_category_children"
  And User click "filter_category_credit_card"
  And User click "filter_category_education"
  And User click "filter_category_utilities"
  And User click "filter_done"
  Then "filter_category_applied_counter" will be displayed
...
Scenario: JENI291-C68345-Verify functionality of 'Reset' button
  ...
  And User click "filter_icon"
  And User click "filter_reset"
  Then User expect "filter_category_applied" doesn't exist
...
Scenario: JENI292-C68349-[Functionality] Verify that 'SELECT ALL' button should select all listed transaction types 
  ...
  And User click "filter_transaction_type"
  And User click "filter_select_all"
  Then User expect "filter_transaction_type_selected" is exist

@continuous @android @uidatabound @R3_4
Scenario: JENI292-C68352-[Functionality] Verify that Clicking 'Clear' when 1 or more listed transaction type(s) have been selected should cause them become unselected 
  And User click "filter_clear"
  Then "in_and_out_filter_unselected_filter" will be displayed
...
Scenario: JENI292-C68357#C68359-[Functionality] Clicking 'APPLY FILTER' when 1 or more transaction type(s) have been selected should Apply the filter on listed transactions 
  Given User is logged in with cif "card_center_m_card_transaction_history_uk_cif"
  And User change language to "language"
  And User access card center from side menu
  And User check and click "card_center_close_tutorial" if exist
  And User click "card_center_m_card_clickable"
  And User click "card_center_transactions_tab"
  Then User expect "in_and_out_number_transaction" is exist
  And User click "filter_icon"
  And User click "filter_transaction_type"
  And User swipe up until found "filter_transaction_type_card_topup" 
  And User click "filter_transaction_type_card_topup"
  And User click "filter_done"
  And User click "filter_apply_button"
  Then User expect "in_and_out_number_transaction" is exist
...
@android @ios @uidatabound
Scenario: JENI297-C75428-[X-Card] [Functionality]    
  Given User is logged in with cif "card_center_x_card_transaction_history_cif"
  And User change language to "language"
  And User click "dashboard_hamburger_icon"
  And User click "card_center_menu"
...
# JENI-273
@android @uidatabound @R3_4
Scenario: JENI273-C129011-[E-Card][Content] Verify there should be a static text to indicate that a user can select more than 1 transaction 
  Given User is logged in with cif "card_center_e_card_transactions_cif"
  And User change language to "language"
  And User swipe up until found "card_center_e_card_clickable"
  And User click "card_center_title"
  And User wait "card_center_loading_screen" will be gone
  And User check and click "card_center_close_tutorial" if exist
  And User click "card_center_e_card_clickable"
  And User wait "card_center_loading_screen" will be gone
  And User wait 3 seconds
  And User click "card_center_transactions_tab"
  And User click "filter_icon"
...
@android @uidatabound @R3_4
Scenario: JENI273-C129012-[E-Card][Functionality] Verify that 'SELECT ALL' button should select all listed transaction types 
  Given User is logged in with cif "card_center_e_card_transactions_cif"
  And User change language to "language"
  And User swipe up until found "card_center_e_card_clickable"
  And User click "card_center_e_card_clickable"
  ...
  And User click "filter_transaction_type"
  And User click "filter_select_all"
  Then "filter_transaction_type_selected" will be displayed

@continuous @android @uidatabound @R3_4
Scenario: JENI273-C129015-[E-Card][Functionality] Verify that Clicking 'Clear' when 1 or more listed transaction type(s) have been selected should cause them become unselected 
  And User click "filter_clear"
  Then "in_and_out_filter_unselected_filter" will be displayed

@android @uidatabound @R3_4
Scenario: JENI273-C129016-[E-Card][Functionality] Clicking 'Done' when 1 or more transaction is selected should take the user to landing page of filters 
  Given User is logged in with cif "card_center_e_card_transactions_cif"
  And User change language to "language"
  And User swipe up until found "card_center_e_card_clickable"
  And User click "card_center_e_card_clickable"
...
@continuous @android @uidatabound @R3_4
Scenario: JENI273-C129017-[E-Card][Functionality] If 1 or more transaction types have been selected, the landing page should indicate this number next to the filter option 'Transaction Type' 
  Then "filter_transaction_type_applied_counter" will be displayed
  Then User expect "filter_transaction_type_applied_counter" equal with "card_center_filter_all_transaction_types_applied"

@android @uidatabound @R3_4
Scenario: JENI273-C129013-[E-Card][Functionality] Verify that 'Done' button should be disabled/inactive if no transaction is selected 
  Given User is logged in with cif "card_center_e_card_transactions_cif"
  And User change language to "language"
  And User swipe up until found "card_center_e_card_clickable"
  And User click "card_center_e_card_clickable"
...
@android @uidatabound @R3_4
Scenario: JENI273-C129022-[E-Card][Functionality] Clicking back button should not save any changes to existing transaction type filter or selection of new filter 
  Given User is logged in with cif "card_center_e_card_transactions_cif"
  And User change language to "language"
  And User swipe up until found "card_center_e_card_clickable"
  And User click "card_center_e_card_clickable"
...
@android @uidatabound @R3_4
Scenario: JENI273-C129023-[E-Card][Functionality] Verify that Application of transaction filters should increment the 'Active filters' on landing page by 1 
  Given User is logged in with cif "card_center_e_card_transactions_cif"
  And User change language to "language"
  And User access card center from side menu
  And User wait "card_center_loading_screen" will be gone
...
@android @uidatabound @continuous @R3_4
Scenario: JENI273-C129024-[E-Card][Functionality] Verify If all applied transaction types are unselected and changes saved by user, the 'Active filters' count should be reduced by 1 
  And User click "filter_transaction_type"
  And User click "filter_clear"
  And User click "filter_done"
  Then User expect "filter_active_counter" equal with "card_center_active_filter_zero"
...
@android @uidatabound @R3_4
# being referred by:
# JENI273-C129019-[E-Card][Functionality] Clicking 'APPLY FILTER' when 1 or more transaction type(s) have been selected should Take user back to the In & Out tab which was opened before applying transaction type filter
# JENI273-C129020-[E-Card][Functionality] Clicking 'APPLY FILTER' when 1 or more transaction type(s) have been selected should only show relevant transactions when the user navigates to any of the three tabs 
Scenario: JENI273-C129018-[E-Card][Functionality] Clicking 'APPLY FILTER' when 1 or more transaction type(s) have been selected should Apply the filter on listed transactions 
  Given User is logged in with cif "card_center_e_card_transactions_cif"
  And User change language to "language"
  And User access card center from side menu
  And User wait "card_center_loading_screen" will be gone
  ...
  And User click "filter_icon"
  And User click "filter_transaction_type"
  And User click "filter_transaction_type_refund"
  And User click "filter_done"
  And User click "filter_apply_button"
  # assertion for C129019
  Then "card_center_transactions_tab" will be displayed
  # assertion for C129018 & C129020
  Then User expect "card_center_transaction_history_type_item" equal with "filter_transaction_type_refund"


#[JENI-8979] Filter Transaction Type for Card Transaction
@uidatabound @android @R3_4
Scenario:JENI8979-C129067-User [Scenario][TC_86] Filter e-Card Refund on Card Transaction List
  Given User is logged in with cif "bill_payment_user_active"
  And User change language to "language"
  ...
  And User click "card_center_transactions_tab"
  And User click "card_center_filter_icon_button"
  And User click "filter_transaction_type"
  And User click "in_and_out_filter_transaction_type_card_refund"
  And User click "in_and_out_filter_done"
  And User click "in_and_out_apply_filter_button"
  And User expect "card_center_result_card_refund_text" is exist
  And User expect "card_center_result_card_refund_cr_text" is exist

@uidatabound @android @R3_4 
Scenario:JENI8979-C129068-[Scenario][TC_583] Filter e-Card Topup on Card Transaction List
  Given User is logged in with cif "bill_payment_user_active"
  And User change language to "language"
  And User go to card center landing page from side menu
  And User swipe up until found "card_center_e_card_dashboard"
  ...
  And User click "card_center_filter_icon_button"
  And User click "filter_transaction_type"
  And User click "in_and_out_filter_transaction_type_card_top_up"
  And User click "in_and_out_filter_done"
  And User click "in_and_out_apply_filter_button"
  And User expect "card_center_result_card_topup_text" is exist
  And User expect "card_center_result_card_refund_cu_text" is exist

@uidatabound @android @R3_4
Scenario:JENI8979-C129069-[Scenario][TC_86] Filter X-Card Refund on Card Transaction List
  Given User is logged in with cif "bill_payment_user_active"
  And User change language to "language"
  And User go to card center landing page from side menu
...
@uidatabound @android @R3_4
Scenario:JENI8979-C129070-[Scenario][TC_583]Filter X-Card Topup on Card Transaction List
  Given User is logged in with cif "bill_payment_user_active"
  And User change language to "language"
  And User go to card center landing page from side menu
  And User swipe up until found "card_center_first_x_card_dashboard"
