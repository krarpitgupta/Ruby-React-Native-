...
Feature: Dashboard Module
  ...
  @android @ios @uispecific
  Scenario:JENI15-C47852-Verify Account Activation Widget which Status is 'Not Active'
    # Waiting CIF No for Inactive Account
    Given User is on dashboard page in English language with "dashboard_inactive_account"
    Then "dashboard_account_notactive" will be displayed  

  @android @ios @uispecific
  Scenario:JENI15-C47853-Verify Account Activation Widget which Status is 'Not Active'
    # Waiting CIF No for Inactive Account
    Given User is on dashboard page in English language with "dashboard_inactive_account"
    Then "dashboard_account_notactive" will be displayed
  
    When User change language to "language_id"
    Then "dashboard_account_notactive_id" will be displayed
    And "dashboard_profil_picture" will be displayed
    # And User expect "dashboard_account_active_button" is exist

  @android @ios @uispecific
  Scenario:JENI15-C47856-Verify the Account status shown reads 'Not Active' (or Bahasa equivalent)
    # Waiting CIF No for Inactive Account
    Given User is on dashboard page in English language with "dashboard_inactive_account"
    Then "dashboard_account_notactive" will be displayed
  ...
  #JENI310
  @android @uidatabound
  Scenario:JENI310-C17931-Verify a transaction detail
    Given User is on dashboard page in English language with "dashboard_active_account"
    When User swipe up until found "card_center_title"
    Then "dashboard_widget_inandout_tita" will be displayed
    And "dashboard_widget_inandout_double_initial" will be displayed
    And "dashboard_widget_inandout_amount" will be displayed
    And "dashboard_widget_inandout_date" will be displayed
    And User expect there are 3 of "dashboard_inandout_widget_uncategorized"

  @android @uidatabound
  Scenario:JENI310-C17932-Verify the format of transaction date if selected language = EN
    Given User is on dashboard page in English language with "dashboard_active_account"
    When User swipe up until found "card_center_title"
    Then "dashboard_inandout_widget_date" will be displayed

  @android @uidatabound
  Scenario:JENI310-C17933-Verify the category of transactions
    Given User is on dashboard page in English language with "dashboard_active_account"
    When User swipe up until found "card_center_title"
    Then User expect there are 3 of "dashboard_inandout_widget_uncategorized"

  @android @uidatabound
  Scenario:JENI310-C17950-Verify the default category of transactions
    Given User is on dashboard page in English language with "dashboard_active_account"
    When User swipe up until found "card_center_title"
    Then User expect there are 3 of "dashboard_inandout_widget_uncategorized"

  @android @uidatabound
  Scenario:JENI310-C17944-[EN] Check In&Out transaction detail content
    # Use CIF No with active account with in & out transaction
    Given User is on dashboard page in English language with "dashboard_active_account"
    When User swipe up until found "card_center_title"
    Then "dashboard_in_and_out_widget_title" will be displayed
    And "dashboard_inandout_widget_amount" will be displayed
    And "dashboard_inandout_widget_date" will be displayed
    And User expect there are 3 of "dashboard_inandout_widget_uncategorized"

  @android @uidatabound
  Scenario:JENI310-C18595-[ID] Check In&Out transaction detail content
    # Use CIF No with active account with in & out transaction
  ...
  Scenario:JENI284-C18596-Check UI of Wealth Widget when user account status is active and total balance=0
    ...
    Then User expect "dashboard_wealth_widget_total_balance" equal with "dashboard_wealth_total_balance_value_available"

  @android @uidatabound  
  Scenario:JENI288-C18598-Check Wealth Widget when user account status is inactive and user hasn't deposited money into his **** account yet
  ...
  Scenario:JENI284-C18599-Verify Total Balance when user hasn't deposited money into his **** account
    ...
    Given User is on dashboard page in English language with "dashboard_active_account"
    Then User expect "dashboard_wealth_widget_total_balance" equal with "dashboard_wealth_total_balance_value_zero"
  ...
  Scenario:JENI1101-C47810-Verify Active Balance on Wealth Widget should allow for a minimum of 10 digits to be shown
    ...
    Then User expect "dashboard_wealth_widget_total_active_balance" equal with "dashboard_active_balance_value"

  @android @uidatabound
  Scenario:JENI1101-C47811-Verify Savings Balance on Wealth Widget should allow for a minimum of 10 digits to be shown
    Given User is on dashboard page in English language with "dashboard_ten_digit_account"
    Then User expect "dashboard_wealth_widget_total_save_it_balance" equal with "dashboard_save_it_value"

  @android @uidatabound
  Scenario:JENI1101-C47812-Verify Cards Balance on Wealth Widget should allow for a minimum of 10 digits to be shown
    Given User is on dashboard page in English language with "dashboard_ten_digit_account"
    Then User expect "dashboard_wealth_widget_total_card_balance" equal with "dashboard_cards_value"

  @android @uidatabound
  Scenario:JENI1101-C47816-Verify Total Balance on Wealth Widget
    Given User is on dashboard page in English language with "dashboard_ten_digit_account"
    Then User expect "dashboard_wealth_widget_total_balance" equal with "dashboard_total_balance_value"  
  ...
  Scenario:JENI1904-C67778-[Functionality] Verify Saving Balance: 1 flexisaver >0, x number of dreamsaver >0 and x number of maxisaver>0
    Given User is on save it page in English language with "save_it_all_have_balance"
    When User check balances for "save_it_maxi_saver_balance", "save_it_dream_saver_balance", "null_value", "null_value" and "null_value"
    And User click "dashboard_hamburger_icon"
    And User swipe down until found "dashboard_menu"
    And User click "dashboard_menu"
  ...
  Scenario:JENI1904-C67781-[Functionality] Verify Saving Balance: flexisaver =0, x number of dreamsaver >0 and x number of maxisaver>0
    Given User is on save it page in English language with "dashboard_with_dream_maxi_account"
    When User check balances for "save_it_maxi_saver_balance", "save_it_dream_saver_balance", "null_value", "null_value" and "null_value"
    And User click "dashboard_hamburger_icon"
    And User swipe down until found "dashboard_menu"
    And User click "dashboard_menu"
  ...
  Scenario:JENI1904-C67791-[Functionality] Verify Total Balance: Active Balance>0, Card Balance =0 and Saving Balance =0
    Given User is on dashboard page in English language with "dashboard_with_only_active_balance_account"
    When User check balances for "dashboard_wealth_widget_total_save_it_balance", "dashboard_wealth_widget_total_active_balance", "dashboard_wealth_widget_total_card_balance", "null_value" and "null_value"
    Then User check total "dashboard_wealth_widget_total_save_it_balance" balance  
  ...
  @android @uidatabound
  Scenario:JENI1904-C67794-[Functionality] Verify Total Balance: Active Balance=0, Card Balance =0 and Saving Balance =0
  ...
  @android @uispecific
  Scenario:JENI1904-C47730-[Functionality] Verify Card Balance: Error returns when retrieving Active Balance from API
  ...
  Scenario:JENI1904-C67789-[Functionality] Verify Total Balance: Active Balance>0, Card Balance =0 and Saving Balance >0
    Given User is on dashboard page in English language with "save_it_zero_balance_for_all"
    When User check balances for "dashboard_wealth_widget_total_save_it_balance", "dashboard_wealth_widget_total_active_balance", "dashboard_wealth_widget_total_card_balance", "null_value" and "null_value"
    Then User check total "dashboard_wealth_widget_total_balance" balance 
  ...
  @android @ios @uidatabound
  Scenario:JENI25-C17957-[Functionality] Verify on click a particular transaction line item
    ...
    And User click "dashboard_in_and_out_widget_third_transaction_history"
    Then "dashboard_in_and_out_widget_transaction_history_container" will be displayed
  ...
  Scenario:JENI7-C18620-[Functionality] Verify Savings Balance after deposited money into **** account while user account status is active
    Given User is logged in with cif "dashboard_active_account"
    When User check balances for "dashboard_wealth_widget_total_balance", "dashboard_wealth_widget_total_active_balance", "dashboard_wealth_widget_total_card_balance", "null_value" and "null_value"
...
#########################################################################################################
#       Precondition              : - User doesn't have any external transaction yet
#                                   - User account status is inactive
#       Created By                : Novi
#       Expected Result           : - Displaying No Transaction Widget
#                                   - Displaying "See In & Out" hyperlink
#########################################################################################################
  @android @uidatabound
  Scenario:JENI33-C17781-[Functionality] User has not done any external transactions while his account was inactive
    ...
    And User swipe up until found "in_and_out_card_center_widget_on_dashboard"
...
#########################################################################################################
#       Precondition              : - User doesn't have any external transaction yet
#                                   - User account status is in-progress
#       Created By                : Novi
#       Expected Result           : - Displaying No Transaction Widget
#                                   - Displaying "See In & Out" hyperlink
#########################################################################################################
...
#########################################################################################################
#       Precondition              : - User doesn't have any external transaction yet
#                                   - User account status is re-activated after being deactivated
#       Created By                : Novi
#       Expected Result           : - Displaying No Transaction Widget
#                                   - Displaying "See In & Out" hyperlink
#########################################################################################################
...
#                                   - User account status is inactive
#       Created By                : Novi
#       Expected Result           : - Displaying No Transaction history on in and out screen
#########################################################################################################
  @android @uidatabound
