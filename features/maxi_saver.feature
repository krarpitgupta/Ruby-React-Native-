...
Scenario:JENI2440-C69908-Validate the expected amount at maturity in TD simulation 
  ...
  Then User expect the total amount of "save_it_maxi_saver_estimated_principal_amount" will be calculated correctly from "save_it_maxi_saver_principal_input_amount"
  # have an issue, raised to QA
...
Scenario:JENI2440-C69833#C69930#C69936-Create Maxi Saver Succesfully
  Given User is on Save It screen in selected environment and logged with "save_it_cif_with_td"
  And User click "card_center_close_tutorial" until "card_center_close_tutorial" gone
  And User swipe up until found "save_it_create_new_maxi_saver"
  And System save "save_it_overview_maxi_saver_amount" value
...
Scenario:JENI2440-C69934-Verify balance movement after TD creation
  ...
  And User click "card_center_close_tutorial" until "card_center_close_tutorial" gone
  Then User expect "in_and_out_active_balance_value" will be minus with "save_it_principal_amount_4"
...
@android @uidatabound
Scenario:JENI2440-C70017-Verify User should be able to see the details of their New TD 
  Given User is on Save It screen in selected environment and logged with "save_it_cif_without_td"
  And User click "card_center_close_tutorial" until "card_center_close_tutorial" gone
  And User swipe up until found "save_it_create_new_maxi_saver"
  And User click "save_it_create_new_maxi_saver"
  ...
  And User click "save_it_maxi_saver_confirmation_check_box"
  And User click "save_it_maxi_saver_confirmation_button"
  And User swipe up to "save_it_principal_amount_5" text
  And User click "save_it_principal_amount_5" text
  And User check and click "save_it_maxi_saver_detail_coach_mark_touchable" if exist
  And User check and click "save_it_maxi_saver_detail_coach_mark_touchable" if exist
  Then element "save_it_principal_amount_5" text displayed 
  And User expect "save_it_maxi_saver_detail_principal_amount" is exist
...
Scenario:JENI2550-C69862-User want to see Save It Widget Screen
  ...
  Then User expect "save_it_widget_flexi_saver_balance" is exist
...
Scenario:JENI2538-C69982-verify amount of principal TD in TD detail
  ...
  And User click "save_it_widget_maxi_saver_balance"
  And User click "card_center_close_tutorial" until "card_center_close_tutorial" gone
  And User swipe up until found "save_it_maxi_saver_list_item"
  And User click "save_it_maxi_saver_list_item"
...
@android @uidatabound
Scenario:JENI2651-C70417-[Functional] Access product overview 
  Given User is on Dashboard screen in selected environment and logged with "save_it_cif_without_td"
  And User click "hamburger"
  And User click "save_it_side_menu"
  And User click "tutorial_close" until "card_center_tutorial_frame" gone
...
@continuous @android @uidatabound
Scenario:JENI2651-C70420-[[Functional] Close product overview 
...
@android @uidatabound @ios
  Scenario: JENI2543-C70078-[Mobile] Verify User should be able to click CHANGE button in TD Detail
    Given User is logged in with cif "save_it_cif_with_td"
...
Scenario: JENI2543-C70081-[Mobile] Verify User with ARO Cash Out should be able to choose ARO P+I in Change TD page by swiping the options
  ...
  And User click "card_center_close_tutorial" until "card_center_close_tutorial" gone
  Then "save_it_maxi_saver_list_expanded" will be displayed
  And User swipe up to "save_it_maxi_saver_with_cashout" text
  ...
  And User click "save_it_maxi_saver_detail_maturity_option_button" until "save_it_maxi_saver_aro_p" gone
  Then "save_it_maxi_saver_aro_p" will be displayed
...
Scenario: JENI2543-C70082-[Mobile] Verify User with ARO P should be able to choose ARO P+I in Change TD page by swiping the options
  ...
  And User click "card_center_close_tutorial" until "card_center_close_tutorial" gone
  Then "save_it_maxi_saver_list_expanded" will be displayed
  And User swipe up to "save_it_maxi_saver_with_aro_p" text
  And User click element with text "save_it_maxi_saver_with_aro_p" 
  And User wait "save_it_maxi_saver_loading_screen" will be gone
  And User click "save_it_maxi_saver_detail_coach_mark_touchable" until "save_it_maxi_saver_detail_coach_mark_touchable" gone
  And User wait "save_it_maxi_saver_loading_screen" will be gone
  And User click "save_it_maxi_saver_detail_maturity_option_button" until "save_it_maxi_saver_aro_pi" displayed
  Then "save_it_maxi_saver_aro_pi" will be displayed
...
Scenario: JENI2543-C70088-[Mobile] Verify if the Narrative of confirmation pop-up is matched with the new chosen ARO setting
  Given User is logged in with cif "save_it_no_balance_for_dream_flexi_saver"
  And User change language to "language"
  And User wait 5 seconds
  And User swipe up until found "save_it_widget_maxi_saver_balance"
  And User click "save_it_widget_maxi_saver_balance"
...
Scenario: JENI2543-C70091-[Mobile] Verify User should be able to see the success message snackbar in the new TD detail after click YES, I'M SURE in confirmation pop-up
  ...
  # And User wait "save_it_maxi_saver_loading_screen" will be gone
  # assertion for C70091
  Then User check snackbar with dynamic text "save_it_maxi_saver_change_to_aro_p_notification"
  # assertion for C70090
  And "save_it_maxi_saver_detail_screen" will be displayed
  # assertion for C70108
  And User expect "save_it_maxi_saver_detail_aro_setting" equal with "save_it_maxi_saver_rop"
  Then User check snackbar with static text "save_it_maxi_saver_change_to_aro_p_notification"

@android @endtoend @ios @continuous
...
Scenario: JENI2543-C70109-Verify User should be able to see the new ARO setting of TD in Save It overview
  Given User is logged in with cif "save_it_cif_with_td"
  And User change language to "language"
  Then "dashboard" will be displayed
  And User swipe up until found "save_it_widget_maxi_saver_balance"
  ...
  And User click "card_center_close_tutorial" until "card_center_close_tutorial" gone
  Then "save_it_maxi_saver_list_expanded" will be displayed
  And User swipe up to "save_it_maxi_saver_with_aro_p_i" text
  And User click element with text "save_it_maxi_saver_with_aro_p_i"
  And User wait "save_it_maxi_saver_loading_screen" will be gone
  Then "save_it_maxi_saver_detail_coach_mark_touchable" will be displayed
  And User click "save_it_maxi_saver_detail_coach_mark_touchable" until "save_it_maxi_saver_detail_coach_mark_touchable" gone
  And User click "save_it_maxi_saver_detail_maturity_option_button" until "save_it_maxi_saver_aro_p" displayed
  Then "save_it_maxi_saver_aro_p" will be displayed
  And User swipe from "save_it_maxi_saver_aro_p" to "save_it_maxi_saver_cash_out"
  Then "save_it_maxi_saver_cash_out" will be displayed
  And User click "save_it_select_aro_next_button" until "save_it_maxi_saver_confirmation_button_yes" displayed
  Then User expect "save_it_maxi_saver_confirmation_button_yes" is exist
  And User click "save_it_maxi_saver_confirmation_button_yes"
  And User wait "save_it_maxi_saver_loading_screen" will be gone
  And User expect "top_notification_snackbar" equal with "save_it_maxi_saver_change_aro_success"
  #Then verify new td detail
  #Then user check list in save_it
...
Scenario: JENI2543-C70120#C70121#C70122-[Mobile] Verify warning pop-up message when reach max edit ARO setting parameter
  Given User is logged in with cif "save_it_no_balance_for_flexi_maxi_saver"
  And User change language to "language"
  And User wait 5 seconds
  And User swipe up until found "save_it_widget_maxi_saver_balance"
  And User click "save_it_widget_maxi_saver_balance"
  And User check and click "card_center_close_tutorial" if exist
  And User swipe up to element contains "save_it_max_edit_td_id" text
  And User click element contains "save_it_max_edit_td_id" text
  And User click "save_it_maxi_saver_detail_coach_mark_touchable" until "save_it_maxi_saver_detail_coach_mark_touchable" gone
  And User click "save_it_maxi_saver_detail_maturity_option_button"
...
Scenario: JENI4258-C81033-[Scenario] Top up more money to existing DS
    ...
    And User click "save_it_dream_saver_list_collapse"
    Then "save_it_dream_saver_list_expanded" will be displayed
    And User swipe up to element contains "save_it_dream_saver_name_1" text
    And User click element with text "save_it_dream_saver_name_1"
    Then element with "save_it_dream_saver_name_1" text will be displayed
...
Scenario: JENI2549-C70069-[Functional] Verify User able to Terminate TD
    ...
    Then User expect "top_notification_snackbar" equal with "save_it_maxi_saver_terminated_successfully"
...
Scenario: JENI2549-C70070-[Functional] Verify User able to click Term & Condition Menu
    ...
    And User click "save_it_maxi_saver_list_collapse"
    Then "save_it_maxi_saver_list_expanded" will be displayed
    And User swipe up to elemetn contains "save_it_maxi_saver_with_cashout" text
    And User click element contains "save_it_maxi_saver_with_cashout" text
    And User wait "save_it_maxi_saver_loading_screen" will be gone
    # Then "save_it_maxi_saver_detail_coach_mark_touchable" will be displayed
    And User click "save_it_maxi_saver_detail_coach_mark_touchable" until "save_it_maxi_saver_detail_coach_mark_touchable" gone
...
@android @uidatabound
Scenario: JENI2545-C70020#C70021#C70022#C70023#C70024#C70026-Verify TD confirmation screen
  Given User is on Save It screen in selected environment and logged with "save_it_cif_with_td"
  And User click "card_center_close_tutorial" until "card_center_close_tutorial" gone
  And User swipe up until found "save_it_create_new_maxi_saver"
  # And System save "save_it_overview_maxi_saver_amount" value
  ...
  # Then User expect "save_it_maxi_saver_confirmation_screen_principal" equal with "save_it_principal_amount_5_label_with_curr"
  # # assertion for C70024
  # Then User expect "save_it_maxi_saver_confirmation_screen_interest" equal with "save_it_annual_interest_rate_2_label"
...
@continuous @android @uidatabound
Scenario: JENI2545-C70033-User should be able to click "Back" button on app
  And User click "back_button"
  Then "save_it_maxi_saver_select_aro_screen" will be displayed

@continuous @android @uidatabound
Scenario: JENI2545-C70027-Verify Maturity date on confirmation screen when user choose Roll Over Principal + Interest
  And User swipe the right menu to the left 
...
@continuous @android @uidatabound
Scenario: JENI2545-C70028-Verify Maturity date on confirmation screen when user choose Return to Active Balance
  And User click "back_button"
  And User swipe the right menu to the left 
  And User swipe the right menu to the left 
  And User swipe the right menu to the left 
...
@continuous @android @uidatabound
Scenario: JENI2545-C70029-User should be able to tick "Term&Condition" option on confirmation screen
  And User click "save_it_maxi_saver_confirmation_check_box"
  Then "save_it_maxi_saver_confirmation_check_box_checked" will be displayed

@continuous @android @uidatabound
Scenario: JENI2545-C70025-Verify Estimated Total Amount on confirmation screen when user create TD
...
@continuous @android @uidatabound
Scenario: JENI2545-C70030-User should be able to click "Term&Condition" detail link on confirmation screen
  And User click "save_it_maxi_saver_confirmation_tc_link"
  And User wait 5 seconds
  Then "save_it_maxi_saver_confirmation_tc_page" will be displayed

@continuous @android @uidatabound
Scenario: JENI2545-C70032#C70052-Verify the Confirm Button is enable when Term and Condition is ticked
  Given User is on Save It screen in selected environment and logged with "save_it_cif_with_td"
  And User click "card_center_close_tutorial" until "card_center_close_tutorial" gone
  And User swipe up until found "save_it_create_new_maxi_saver"
  And User click "save_it_create_new_maxi_saver"
  ...
  And User click "save_it_maxi_saver_confirmation_check_box"
  And User click "save_it_maxi_saver_confirmation_button"
  # Then "save_it_container" will be dispalyed
...
# Scenario: JENI2545-C70052-Verify User Back to TD Overview Page after click Confirmation Page
  # And User click "save_it_maxi_saver_confirmation_button_yes"
  Then User expect "top_notification_snackbar" equal with "save_it_maxi_saver_creation_success_message"
  And "save_it_container" will be displayed
...
Scenario: JENI4184-C80851-[Scenario] User is able to create 10 account as max
    Given User is logged in with cif "save_it_cif_with_nine_active_ds"
    And User change language to "language"
    Then "dashboard" will be displayed
    And User swipe up until found "save_it_widget_create_dream_saver"
    Then User click "save_it_widget_create_dream_saver" 
...
Scenario: JENI4184-C80852-[Scenario] Navigate to Dream Saver screen
    ...
    Then "save_it_dream_saver_name_input_field" will be displayed
    Then "save_it_dream_saver_name_input_field" will be displayed
    Then "save_it_dream_saver_target_amount_input_field" will be displayed
    Then "save_it_dream_saver_next_button" will be displayed
...
Scenario: JENI4184-C80856-[Scenario] Input target amount
    ...
    And User click "card_center_close_tutorial" until "card_center_close_tutorial" gone
    Then "save_it_dream_saver_name_input_field" will be displayed
    Then "save_it_dream_saver_target_amount_hint" will be displayed
    And User fill "save_it_dream_saver_target_amount_input_field" with "save_it_dream_saver_zero_target_amount"
    Then User expect "save_it_dream_saver_target_amount_hint" equal with "save_it_dream_saver_min_target_amount_hint"
    And User fill "save_it_dream_saver_target_amount_input_field" with "save_it_dream_saver_under_one_thousand_target_amount"
    Then User expect "save_it_dream_saver_target_amount_hint" equal with "save_it_dream_saver_min_target_amount_hint"
    And User fill "save_it_dream_saver_target_amount_input_field" with "save_it_dream_saver_one_thousand_target_amount"
    Then User expect "save_it_dream_saver_target_amount_hint" doesn't exist
    And User fill "save_it_dream_saver_target_amount_input_field" with "save_it_dream_saver_one_bilion_target_amount"
    Then User expect "save_it_dream_saver_target_amount_hint" doesn't exist
    And User fill "save_it_dream_saver_target_amount_input_field" with "save_it_dream_saver_above_target_amount"
    Then User expect "save_it_dream_saver_target_amount_hint" equal with "save_it_dream_saver_max_target_amount_hint"
...
Scenario: JENI2543-C70087-[Mobile] Verify User should be able to see the confirmation pop-up after click CONFIRM button
  ...
  And User click "save_it_maxi_saver_list_collapse"
  And User click "save_it_maxi_saver_list_item"
  And User check and click "save_it_maxi_saver_detail_coach_mark_touchable"
  And User check and click "save_it_maxi_saver_detail_coach_mark_touchable"
  And User click "save_it_edit_maxi_saver_label"
  And User click "save_it_select_aro_next_button"
  And User click "save_it_maxi_saver_confirmation_check_box"
  And User click "save_it_maxi_saver_confirmation_button"
...
Scenario: JENI2543-C70087-[Mobile] Verify User should be able to see the confirmation pop-up after click CONFIRM button
  ...
  And User swipe up until found "save_it_create_new_maxi_saver"
  And System save "save_it_overview_maxi_saver_amount" value
  And User expect "save_it_maxi_saver_summary_amount" is exist
  And User input texts "save_it_maxi_saver_summary_amount" into variable
  Then User check texts
